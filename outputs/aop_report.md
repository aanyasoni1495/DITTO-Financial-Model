...
Generated using the live retention curve (Monthly: sBG, 3-Month: sBG, curve dated 2026-09-09). Re-running this after the retention model refits will automatically use the new curve -- nothing here is hardcoded.
